...
clock = Tk()#to create window
#graphic inside
clock.title(">DIGITAL  CLOCK<")#Title of box
clock.geometry('1000x500')#size of window
clock.config(bg="#83e4f7")#bg color
#upper gap 1,2,3,4
lab_hr=Label(clock,text="00",font=('Time New Roman',50,"bold"),bg="black",fg="white" )
...
lab_min=Label(clock,text="00",font=('Time New Roman',50,"bold"),bg="black",fg="white" )
...
lab_sec=Label(clock,text="00",font=('Time New Roman',50,"bold"),bg="black",fg="white" )
...
lab_am=Label(clock,text="00",font=('Time New Roman',50,"bold"),bg="black",fg="white" )
...
#lower block  date 1,2,3,4

lab_date=Label(clock,text="00",font=('Time New Roman',50,"bold"),bg="black",fg="white" )
...
lab_mo=Label(clock,text="00",font=('Time New Roman',50,"bold"),bg="black",fg="white" )
...
lab_mo_txt.place(x=340,y=400,height=40,width=100)


lab_year=Label(clock,text="00",font=('Time New Roman',50,"bold"),bg="black",fg="white" )
...
#this
date_time()
clock.mainloop()#to create window